...
{
    public class ZipValidator : DataAnnotationsModelValidator<ZipAttribute>
    {
        #region Fields
        ...
        public ZipValidator(ModelMetadata metadata, ControllerContext context, ZipAttribute attribute) : base(metadata, context, attribute)
        {
